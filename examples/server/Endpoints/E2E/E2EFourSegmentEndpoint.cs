...
/// <summary>
///     E2E scenario: update available, release version expressed as a 4-segment Win32 version
///     (2.0.0.1). Validates that the client's version normalisation honours the revision segment,
///     so a local version of "2.0.0" (revision 0) is correctly seen as outdated.
///     Expected updater exit code: <c>NV_S_UPDATE_FINISHED = 203</c>.
///     Only active when <c>VICIUS_E2E=1</c>.
/// </summary>
internal sealed class E2EFourSegmentEndpoint : EndpointWithoutRequest
{
    public override void Configure()
    {
        Get("api/e2e/FourSegment/updates.json");
        AllowAnonymous();
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        UpdateResponse response = new()
        {
            Shared = new SharedConfig
            {
                ...
                WindowTitle = "E2E FourSegment Updater"
            },
            Releases =
            {
                new UpdateRelease
                {
                    Name = "E2E ZIP Update v2.0.0.1",
                    // 4-segment version: the client must normalise "2.0.0.1" and compare it
                    // against a local "2.0.0" (revision 0), concluding it is outdated.
                    Version = System.Version.Parse("2.0.0.1"),
